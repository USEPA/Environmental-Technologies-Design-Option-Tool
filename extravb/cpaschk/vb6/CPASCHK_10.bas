Attribute VB_Name = "CPASCHK_10"
Option Explicit




Const CPASCHK_10_declarations_end = True


Sub Do_Create_File_v10(arg_CpasDir As String)
...
Dim fpath_OutputDir As String
  ...
  On Error GoTo err_Do_Create_File_v10
...
exit_err_Do_Create_File_v10:
  'ERRORS OCCURED; EXIT WITH AN ERROR CODE.
  Call ExitError(fpath_OutputDir, LICFILE_BadSerialNumber)
  'Call ExitError(arg_CpasDir, LICFILE_BadSerialNumber)
  End   'redundant
err_Do_Create_File_v10:
  Resume exit_err_Do_Create_File_v10
End Sub


Sub Do_Display_All_v10(arg_CpasDir As String)
Dim fn_CPASLIC As String
Dim dummy As String
Dim i As Integer
Dim lfdt As LicFile_Data_Type
...
Sub Do_Get_Info_v10(arg_CpasDir As String, arg_ProgramKey As String, arg_ResultsDir As String)
Dim fn_test As String
Dim lfdt As LicFile_Data_Type
...
Dim fpath_OutputDir As String
  ...
  On Error GoTo err_Do_Get_Info_v10
...
'MsgBox "s_date(2) = `" & s_date(2) & "`,s_time(2) = `" & s_time(2) & "`"
      ...
      Else
        'PERFORM THE CHECK.
        If (Len(s_date(2)) <> 8) Then GoTo exit_err_Do_Get_Info_v10
        If (Len(s_time(2)) <> 6) Then GoTo exit_err_Do_Get_Info_v10
