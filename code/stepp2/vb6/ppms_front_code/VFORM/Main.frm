...
Begin VB.Form frmMain 
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   631
   Begin VB.CommandButton cmd_Load_PPMS_Calc 
      Caption         =   "Load PPMS-Calc Module"
      Height          =   795
      Left            =   240
      TabIndex        =   18
      Top             =   270
...
Private Sub cmd_Load_PPMS_Calc_Click()
  Call Launch_Plugin_Go(LaunchFunc_PPMS_Calc)
End Sub
...
Dim fn_This As String
  Select Case index
    ...
    Case 80:
      fn_This = MAIN_APP_PATH & "\dbase\readme_ppms_front.txt"
      If (FileExists(fn_This) = False) Then
        Call Show_Message("The file `" & fn_This & "` is missing.")
        Exit Sub
      End If
