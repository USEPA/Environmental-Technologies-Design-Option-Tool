VERSION 2.00
Begin Form frmSeparationFactors 
   BackColor       =   &H00C0C0C0&
   ...
   Begin SSPanel panelIons 
      ...
      End
   End
   Begin SSOption optSeparationFactors 
      Height          =   252
      Index           =   20
      Left            =   8760
      TabIndex        =   169
   ...
   Begin SSOption optSeparationFactors 
      ...
      Width           =   312
   End
   Begin TextBox txtSeparationFactorsRow3 
      Alignment       =   2  'Center
      Height          =   288
      Index           =   4
      Left            =   3240
      ...
      Width           =   732
   End
   Begin SSPanel panelDescription 
      Height          =   1632
      Left            =   4320
      TabIndex        =   148
      Top             =   4680
   ...
   Begin CommandButton cmdOK 
      ...
      Width           =   732
   End
   Begin TextBox txtSeparationFactorsRow10 
      Alignment       =   2  'Center
      Enabled         =   0   'False
      Height          =   288
      Index           =   10
   ...
   Begin TextBox txtSeparationFactorsRow10 
      ...
      Width           =   732
   End
   Begin TextBox txtSeparationFactorsRow9 
      Alignment       =   2  'Center
      Height          =   288
      Index           =   10
      Left            =   7920
   ...
   Begin TextBox txtSeparationFactorsRow9 
      ...
      Width           =   732
   End
   Begin TextBox txtSeparationFactorsRow8 
      Alignment       =   2  'Center
      Height          =   288
      Index           =   10
      Left            =   7920
   ...
   Begin TextBox txtSeparationFactorsRow8 
      ...
      Width           =   732
   End
   Begin TextBox txtSeparationFactorsRow7 
      Alignment       =   2  'Center
      Height          =   288
      Index           =   10
      Left            =   7920
   ...
   Begin TextBox txtSeparationFactorsRow7 
      ...
      Width           =   732
   End
   Begin TextBox txtSeparationFactorsRow6 
      Alignment       =   2  'Center
      Height          =   288
      Index           =   10
      Left            =   7920
   ...
   Begin TextBox txtSeparationFactorsRow6 
      ...
      Width           =   732
   End
   Begin TextBox txtSeparationFactorsRow5 
      Alignment       =   2  'Center
      Height          =   288
      Index           =   10
      Left            =   7920
   ...
   Begin TextBox txtSeparationFactorsRow5 
      ...
      Width           =   732
   End
   Begin TextBox txtSeparationFactorsRow4 
      Alignment       =   2  'Center
      Height          =   288
      Index           =   10
      Left            =   7920
   ...
   Begin TextBox txtSeparationFactorsRow3 
      ...
      Width           =   732
   End
   Begin TextBox txtSeparationFactorsRow2 
      Alignment       =   2  'Center
      Height          =   288
      Index           =   10
      Left            =   7920
   ...
   Begin TextBox txtSeparationFactorsRow2 
      ...
      Width           =   732
   End
   Begin TextBox txtSeparationFactorsRow1 
      Alignment       =   2  'Center
      Height          =   288
      Index           =   10
      Left            =   7920
...
Sub DisplayDownAColumn (Column As Integer)
...
Sub optSeparationFactors_Click (Index As Integer, Value As Integer)
...
Sub txtSeparationFactorsRow1_GotFocus (Index As Integer)
    Call TextGetFocus(txtSeparationFactorsRow1(Index), Temp_Text)
End Sub

Sub txtSeparationFactorsRow1_KeyPress (Index As Integer, KeyAscii As Integer)
...
Sub txtSeparationFactorsRow1_LostFocus (Index As Integer)
...
Sub txtSeparationFactorsRow10_GotFocus (Index As Integer)
    Call TextGetFocus(txtSeparationFactorsRow10(Index), Temp_Text)
End Sub

Sub txtSeparationFactorsRow10_KeyPress (Index As Integer, KeyAscii As Integer)
...
Sub txtSeparationFactorsRow10_LostFocus (Index As Integer)
    Dim ValueChanged As Integer, NewValue As Double, IsError As Integer
    Dim msg As String, CurrentUnits As Integer
    Dim OldValue As Double, ValueToDisplay As Double
...
Sub txtSeparationFactorsRow100_LostFocus (Index As Integer)
    Dim ValueChanged As Integer, NewValue As Double, IsError As Integer
    Dim msg As String, CurrentUnits As Integer
    Dim OldValue As Double, ValueToDisplay As Double
...
Sub txtSeparationFactorsRow2_GotFocus (Index As Integer)
    Call TextGetFocus(txtSeparationFactorsRow2(Index), Temp_Text)
End Sub

Sub txtSeparationFactorsRow2_KeyPress (Index As Integer, KeyAscii As Integer)
...
Sub txtSeparationFactorsRow2_LostFocus (Index As Integer)
    Dim ValueChanged As Integer, NewValue As Double, IsError As Integer
    Dim msg As String, CurrentUnits As Integer
    Dim OldValue As Double, ValueToDisplay As Double
...
Sub txtSeparationFactorsRow3_GotFocus (Index As Integer)
    Call TextGetFocus(txtSeparationFactorsRow3(Index), Temp_Text)
End Sub

Sub txtSeparationFactorsRow3_KeyPress (Index As Integer, KeyAscii As Integer)
...
Sub txtSeparationFactorsRow3_LostFocus (Index As Integer)
    Dim ValueChanged As Integer, NewValue As Double, IsError As Integer
    Dim msg As String, CurrentUnits As Integer
    Dim OldValue As Double, ValueToDisplay As Double
...
Sub txtSeparationFactorsRow4_GotFocus (Index As Integer)
    Call TextGetFocus(txtSeparationFactorsRow4(Index), Temp_Text)
End Sub

Sub txtSeparationFactorsRow4_KeyPress (Index As Integer, KeyAscii As Integer)
...
Sub txtSeparationFactorsRow4_LostFocus (Index As Integer)
    Dim ValueChanged As Integer, NewValue As Double, IsError As Integer
    Dim msg As String, CurrentUnits As Integer
    Dim OldValue As Double, ValueToDisplay As Double
...
Sub txtSeparationFactorsRow5_GotFocus (Index As Integer)
    Call TextGetFocus(txtSeparationFactorsRow5(Index), Temp_Text)
End Sub

Sub txtSeparationFactorsRow5_KeyPress (Index As Integer, KeyAscii As Integer)
...
Sub txtSeparationFactorsRow5_LostFocus (Index As Integer)
    Dim ValueChanged As Integer, NewValue As Double, IsError As Integer
    Dim msg As String, CurrentUnits As Integer
    Dim OldValue As Double, ValueToDisplay As Double
...
Sub txtSeparationFactorsRow6_GotFocus (Index As Integer)
    Call TextGetFocus(txtSeparationFactorsRow6(Index), Temp_Text)
End Sub

Sub txtSeparationFactorsRow6_KeyPress (Index As Integer, KeyAscii As Integer)
...
Sub txtSeparationFactorsRow6_LostFocus (Index As Integer)
    Dim ValueChanged As Integer, NewValue As Double, IsError As Integer
    Dim msg As String, CurrentUnits As Integer
    Dim OldValue As Double, ValueToDisplay As Double
...
Sub txtSeparationFactorsRow7_GotFocus (Index As Integer)
    Call TextGetFocus(txtSeparationFactorsRow7(Index), Temp_Text)
End Sub

Sub txtSeparationFactorsRow7_KeyPress (Index As Integer, KeyAscii As Integer)
...
Sub txtSeparationFactorsRow7_LostFocus (Index As Integer)
    Dim ValueChanged As Integer, NewValue As Double, IsError As Integer
    Dim msg As String, CurrentUnits As Integer
    Dim OldValue As Double, ValueToDisplay As Double
...
Sub txtSeparationFactorsRow8_GotFocus (Index As Integer)
    Call TextGetFocus(txtSeparationFactorsRow8(Index), Temp_Text)
End Sub

Sub txtSeparationFactorsRow8_KeyPress (Index As Integer, KeyAscii As Integer)
...
Sub txtSeparationFactorsRow8_LostFocus (Index As Integer)
    Dim ValueChanged As Integer, NewValue As Double, IsError As Integer
    Dim msg As String, CurrentUnits As Integer
    Dim OldValue As Double, ValueToDisplay As Double
...
Sub txtSeparationFactorsRow9_GotFocus (Index As Integer)
    Call TextGetFocus(txtSeparationFactorsRow9(Index), Temp_Text)
End Sub

Sub txtSeparationFactorsRow9_KeyPress (Index As Integer, KeyAscii As Integer)
...
Sub txtSeparationFactorsRow9_LostFocus (Index As Integer)
    Dim ValueChanged As Integer, NewValue As Double, IsError As Integer
    Dim msg As String, CurrentUnits As Integer
    Dim OldValue As Double, ValueToDisplay As Double
