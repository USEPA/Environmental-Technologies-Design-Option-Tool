...
End Sub
Sub ChangeDir_Examples()
  ChDrive MAIN_APP_PATH
  ChDir MAIN_APP_PATH & "\EXAMPLES"
End Sub
Sub ChangeDir_Main()
  ChDrive MAIN_APP_PATH
  ChDir MAIN_APP_PATH
...
''''    MAIN_APP_PATH = "X:\etdot10\code\ionex_6\vb6"
    MAIN_APP_PATH = "X:\etdot10\code\ionex\ionex_6\vb6"
'    ChDrive MAIN_APP_PATH
    ChDir MAIN_APP_PATH
  Else
    If InStr(1, CurDir(), "examples", 1) > 0 Then
''''      MAIN_APP_PATH = "x:\etdot10\code\ionex_6\vb6"
      MAIN_APP_PATH = "X:\etdot10\code\ionex\ionex_6\vb6"
      ChDir MAIN_APP_PATH
    Else
