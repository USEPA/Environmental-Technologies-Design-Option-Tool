...
Sub file_new()
  ...
  'This didn't work because this procedure is used in other places that call file_new
  'which puts it in a loop
'  Call File_Open(App.Path & "\dbase\default.iex")
  Current_Filename = ""
  frmIonExchangeMain.Caption = Name_App_Short & "  -  (Untitled)"
...
'  Call InitializeTimeAndCollocationInfo
  ...
  Is_Dirty = False
  Call Global_DirtyStatus_Set(frmIonExchangeMain, Is_Dirty, False)
End Sub
...
Dim DataVersion_Minor As Integer
  ...
  If (Not FileExists(fn_Open)) Then
    ...
    GoTo exit_sub
  End If
  frmIonExchangeMain.MousePointer = 11
...
'          Call file_new
  ...
  frmIonExchangeMain.Caption = Name_App_Short & "  -  " & Trim$(Current_Filename)
  Call frmIonExchangeMain_Refresh
  'CLEAR DIRTY FLAG.
  ...
  GoTo exit_sub
exit_sub:
  frmIonExchangeMain.MousePointer = 0
  Exit Sub
exit_invalid_format:
...
Dim fn_openas As String
  ...
  Else
    ...
    Call ChangeDir_Examples
    frmIonExchangeMain.CMDialog1.DialogTitle = "Open " & Name_App_Short & " File"
    'frmIonExchangeMain.CMDialog1.Filter = "All Files (*.*)|*.*|" & _
    '    Name_App_Short & " Files (*.dat)|*.dat"
    frmIonExchangeMain.CMDialog1.Filter = "All Files (*.*)|*.*|" & _
        Name_App_Short & " Files (*." & FileExt_App & ")|*." & _
        FileExt_App
    frmIonExchangeMain.CMDialog1.FilterIndex = 2
    frmIonExchangeMain.CMDialog1.CancelError = True
    frmIonExchangeMain.CMDialog1.flags = _
        cdlOFNFileMustExist + _
        cdlOFNPathMustExist
    frmIonExchangeMain.CMDialog1.ShowOpen
    fn_openas = Trim$(frmIonExchangeMain.CMDialog1.filename)
    If (fn_openas = "") Then
      'DO NOTHING.
      Exit Sub
    End If
...
Dim RetVal As Integer
  ...
  Else
    Do While (1 = 1)
      ...
      frmIonExchangeMain.CMDialog1.DialogTitle = "Save " & _
          Name_App_Short & " File"
      frmIonExchangeMain.CMDialog1.Filter = _
      ...
      frmIonExchangeMain.CMDialog1.flags = _
          ...
          cdlOFNPathMustExist
      frmIonExchangeMain.CMDialog1.ShowSave
      fn_saveas = Trim$(frmIonExchangeMain.CMDialog1.filename)
      If (fn_saveas = "") Then
        'DO NOTHING.
        Exit Function
      End If
