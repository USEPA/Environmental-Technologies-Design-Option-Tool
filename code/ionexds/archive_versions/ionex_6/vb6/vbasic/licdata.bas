...
Global Const AppProgramKey = "IONEX"
...
Global Const Application_Name = "Simulation Program for Ion Exchange"

Global Const Name_App_Short = "IONEX"
Global Const Name_App_Long = "Simulation Program for Ion Exchange"
Global Const FileExt_App = "iex"
Global Const fn_INI_name = "IONEX.INI"     'non-full name NOT including Windows path
'
