...
Begin VB.Form frmOptionsInputParameters 
   ...
   ScaleHeight     =   5340
   ScaleWidth      =   5895
   Begin VB.PictureBox fraNumberOfBeds 
      Appearance      =   0  'Flat
      BackColor       =   &H80000005&
      ForeColor       =   &H00000000&
      Height          =   675
      ...
      Top             =   120
      Width           =   4575
      Begin VB.PictureBox spnNumberOfBeds 
         Appearance      =   0  'Flat
         BackColor       =   &H80000005&
         ForeColor       =   &H80000008&
         Height          =   285
...
'    Input_Exist = True
    ...
    If (Bed.NumberOfBeds = 1) Or (TimeParameters.InitialTime < 0.00011) Then

    Else   'For beds in series, initial time must be approximately zero
       TimeParameters.InitialTime = 0.0001
