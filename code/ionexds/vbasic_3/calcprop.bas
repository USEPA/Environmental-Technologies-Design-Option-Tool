...
''''       Anion(i).Kinetic.ReynoldsNumber = GetReynoldsNumber(Resin.ParticleDiameter, Bed.InterstitialVelocity, Operating.LiquidDensity, Operating.LiquidViscosity) 
       Anion(i).Kinetic.ReynoldsNumber = GetReynoldsNumber(Resin.ParticleDiameter * 100#, Bed.InterstitialVelocity, Operating.LiquidDensity, Operating.LiquidViscosity)
