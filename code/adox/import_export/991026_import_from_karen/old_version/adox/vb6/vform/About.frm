...
Begin VB.Form frmAbout 
   ...
   Begin VB.Label lblVersionInfo 
      ...
      BackColor       =   &H80000005&
      BackStyle       =   0  'Transparent
      Caption         =   "(Build Code XX) (Invisible, no longer used.)"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
...
Private Sub Form_Load()
  ...
  ' VARIOUS LABELS.
  '
  Me.Caption = "About " & Name_App_Long
  lblProgramName.Caption = Name_App_Short
  ...
  lblVersionInfo(3).Caption = AppCopyrightLine1
  lblVersionInfo(4).Caption = AppCopyrightLine2
