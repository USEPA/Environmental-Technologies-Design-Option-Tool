   ...
   Begin Threed.SSPanel sspanel_logos 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.PictureBox picLogos 
            ...
            Width           =   3315
         End
         Begin VB.Label lblLogoTitles 
            Alignment       =   2  'Center
            BackColor       =   &H00C0C0C0&
            Caption         =   "lblLogoTitles added at Run Time"
            Height          =   1125
            Left            =   90
            TabIndex        =   19
            Top             =   1860
...
Dim s As String
  ...
  If (splash_mode = 0) Then
    ...
    lblLogoTitles = "National Center for " & Chr$(13) & _
      "Clean Industrial and Treatment Technologies" & Chr$(13) & Chr$(13) & _
      "Michigan Technogical University" & Chr$(13) & _
      "Houghton, Michigan"
    lblAuthors = "Ke Li" & Chr$(13) & Chr$(13) & _
