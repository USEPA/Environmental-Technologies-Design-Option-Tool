   ...
   Begin Threed.SSPanel sspanel_logos 
      ...
      Begin Threed.SSPanel Panel3D3 
         ...
         Begin VB.Label lblAuthors 
            ...
            Appearance      =   0  'Flat
            BackColor       =   &H00C0C0C0&
            Caption         =   "David R. Hokanson     Tony N. Rogers      David W. Hand"
            ForeColor       =   &H80000008&
            Height          =   225
            Index           =   0
            Left            =   120
         ...
         Begin VB.Label lblAuthors 
            ...
            Appearance      =   0  'Flat
            BackColor       =   &H00C0C0C0&
            Caption         =   "John C. Crittenden     Eric J. Oman"
            ForeColor       =   &H80000008&
            Height          =   225
            Index           =   1
            Left            =   120
      ...
      Begin VB.Label lblCompany 
         ...
         Appearance      =   0  'Flat
         BackColor       =   &H00C0C0C0&
         Caption         =   "National Center for Clean Industrial and Treatment Technologies"
         ForeColor       =   &H80000008&
         Height          =   225
         Index           =   1
         Left            =   60
