...
Global MAIN_EXE_PATH As String
'
...
'>>>>>>>>>>>>>>>>>>>> *TODO* UPDATE THIS PATHNAME <<<<<<<<<<<<<<<<<<<<<<<<<
    MAIN_APP_PATH = "X:\etdot10\code\favor\vb6"
   ' MAIN_APP_PATH = "d:\mtu\favor"
    ChDrive MAIN_APP_PATH
    ChDir MAIN_APP_PATH
  Else
    'DO NOTHING.
  ...
  End If
  MAIN_EXE_PATH = MAIN_APP_PATH & "\EXES"
  '
  ...
  End If
  '
  ' SET UP LINK TO HELP FILE.
  '
  App.HelpFile = MAIN_APP_PATH & "\help\favor.hlp"
  '
