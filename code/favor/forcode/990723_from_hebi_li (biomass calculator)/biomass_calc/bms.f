...
cccc	   WRITE(20,80) I,X(I),X(N+I)
	   WRITE(20,'(I4)') I
	   WRITE(20,'(2E12.4)') X(I)
	   WRITE(20,'(2E12.4)') X(N+I)
  60  CONTINUE


	write(20,*) ' '
	write(20,*) ' '
	write(20,*) '----- List of all input parameters: ---------'
      write(20,*) 'N = ', N
      write(20,*) 'NSF = ', NSF
	DO I=1,N
        write(20,*) 'FFRACT() = ', FFRACT(I)
	ENDDO
      write(20,*) 'NPC = ', NPC
      write(20,*) 'NAB = ', NAB
      write(20,*) 'NSC = ', NSC
	...
	ENDDO
      ...
      write(20,*) 'S0 = ', S0
      write(20,*) 'X0 = ', X0
      write(20,*) 'ITMAX = ', ITMAX
      write(20,*) 'ERRREL = ', ERRREL
