...
!C  ATTRIBUTES DLLEXPORT, STDCALL::FINDKLA
!C  ATTRIBUTES ALIAS:'_FINDKLA@100':: FINDKLA
!C  ATTRIBUTES REFERENCE::KLASAF,KLAOND,KL,KG,AW,STC,ST,ML,AT,DL,VL,DIFL,DP,GM,VG,DG,DIFG,HENRYC,SAFFAC,RE,FR,WE,RL,RG,RT
