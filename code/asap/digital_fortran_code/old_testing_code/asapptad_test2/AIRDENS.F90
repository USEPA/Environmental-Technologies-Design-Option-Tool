...
!C-bsbs...DLLEXPORT, STDCALL::AIRDENS
!C-bsbs...ALIAS:'_AIRDENS':: AIRDENS
!C-bsbs...REFERENCE::DG,TEMP,PRES

!DEC$ ATTRIBUTES DLLEXPORT :: AIRDENS             ! This exports the name
!DEC$ ATTRIBUTES ALIAS : "_AIRDENS" :: AIRDENS !This sets it
