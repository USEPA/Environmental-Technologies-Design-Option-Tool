...
C
C     MODULE NAME: HOFMAN()
C     LONGER NAME: LIQUID-PHASE ADSORPTION ISOTHERM CALCULATOR USING MANES/HOFER MODEL
C
...
C         1999-MAY-14 - OMAN - MODIFIED HOFMAN() ROUTINE TO USE
C           MOLAR VOLUME @ NBP (VOLM_NBP), INSTEAD OF USING MOLAR VOLUME
C           @ OPERATING TEMPERATURE (VOLM=FWT/DENS).
C         1999-MAY-20 - OMAN - MODIFIED HOFMAN() ROUTINE TO USE
...
cC      SUBROUTINE HOFMAN(IN_DATA,NL,CSAV,QSAV,
cC     &                  XK1,XK2,XNF,CBEG,CEND,RSQD,RMSE,
cC     &                  ERRMAT,HOERR,LNCPTS,LNQPTS,NUMPTS)
c      SUBROUTINE HOFMAN(IN_DATA,NL,CSAV,QSAV,
c     &                  XK1,XK2,XNF,CBEG,CEND,RSQD,RMSE,
c     &                  ERRMAT,HOERR)
      SUBROUTINE HOFMAN(IN_DATA,NL,VOLM_NBP,CSAV,QSAV,
