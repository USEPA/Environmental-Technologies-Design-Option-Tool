...
Dim strTest As String
      ...
      Case 1.42:
        ...
        Else
          Call Show_Error("Warning: The selected file contains " & _
              "PSDMR model data which is not accessible " & _
              "using this version of the software.  " & _
  ...
  If (ShowLegacyWarning) Then
    ...
    Call Show_Message00("Warning: This file is formatted as a " & _
        "Version " & Format$(ThisVersion, "0.00") & _
        " file.  If saved, it will be saved as a " & _
        "Version " & Trim$(Str$(Latest_DataVersion_Major)) & "." & _
        Trim$(Str$(Latest_DataVersion_Minor)) & _
        " file.", _
        vbInformation, _
        AppName_For_Display_Short & " : Legacy File Version Warning")
  End If
  Close #f
  'UPDATE DISPLAY.
  Filename = fn_Open
  frmMain.Caption = AppName_For_Display_Short & "  -  " & Trim$(Filename)
...
Dim fn_openas As String
  ...
  Else
    ...
    frmMain.CommonDialog1.DialogTitle = _
        "Open " & AppName_For_Display_Short & " File"
    frmMain.CommonDialog1.Filter = _
        "All Files (*.*)|*.*|" & _
        AppName_For_Display_Short & " Files (*.dat)|*.dat"
  ...
  Else
    Do While (1 = 1)
      ...
      frmMain.CommonDialog1.DialogTitle = "Save " & _
          AppName_For_Display_Short & " File"
...
Dim msg As String
  ...
  RetVal = MsgBox(msg, _
      ...
      AppName_For_Display_Short & " : Save Changes ?")
  Select Case RetVal
    Case vbYes:
