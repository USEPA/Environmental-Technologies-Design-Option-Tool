...
Private Sub Form_Load()
  ...
  lblDisclaimer.Caption = _
      "This is a DEMONSTRATION version of the AdDesignS program. " & _
      "This demonstration version may only load and simulate the " & _
      "LIQUID.DAT and GAS.DAT files in the examples subdirectory. " & _
