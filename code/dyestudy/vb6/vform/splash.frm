   ...
   Begin Threed.SSPanel sspanel_logos 
      ...
      Begin Threed.SSPanel Panel3D3 
         ...
         Begin VB.Label lblAuthors 
            Appearance      =   0  'Flat
            BackColor       =   &H00C0C0C0&
            Caption         =   "Ke Li     David W. Hand     John C. Crittenden"
            ForeColor       =   &H80000008&
            Height          =   225
            Index           =   0
            Left            =   2370
...
'Call debug_output("L5")
    ...
    If UCase(get_program_releasetype()) = "BETA" Then
      lblDisclaimer.Caption = _
        "This is a DEMONSTRATION version of the AdOx/Dyestudy program. " & _
        "This demonstration version cannot be changed or saved. " & _
