  ...
  Else
    ...
    Else
      ...
      Do Until Rs1.EOF
        ...
        Select Case Trim$(UCase$(Database_Get_String(Rs1, "FieldName")))
          'MAIN BLOCK.
          Case Trim$(UCase$("Length")): Call Database_LoadProperty(Rs1, Prj.length)
          Case Trim$(UCase$("Diameter")): Call Database_LoadProperty(Rs1, Prj.Diameter)
          Case Trim$(UCase$("Mass")): Call Database_LoadProperty(Rs1, Prj.Mass)
          Case Trim$(UCase$("FlowRate")): Call Database_LoadProperty(Rs1, Prj.FlowRate)
        End Select
        Rs1.MoveNext
      Loop
      '
