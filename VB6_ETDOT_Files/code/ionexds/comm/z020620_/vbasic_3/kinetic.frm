VERSION 2.00
Begin Form frmInputKineticParameters 
   BackColor       =   &H00C0C0C0&
   ...
   Top             =   -75
   Width           =   8790
   Begin CommandButton cmdKinetic 
   ...
   Begin CommandButton cmdKinetic 
      ...
      Width           =   1476
   End
   Begin SSFrame fraPoreDiffusivityInput 
      ...
      Top             =   5340
      Width           =   4092
      Begin ComboBox cboPoreDiffusivityUnits 
         BackColor       =   &H00C0C0C0&
         Height          =   288
         Index           =   1
         Left            =   2820
      ...
      Begin ComboBox cboPoreDiffusivityUnits 
         ...
         Width           =   1152
      End
      Begin TextBox txtPoreDiffusivityUser 
         Enabled         =   0   'False
         Height          =   288
         Left            =   1740
         TabIndex        =   99
         ...
         Width           =   972
      End
      Begin SSOption optPoreDiffusivity 
         Caption         =   "User Input"
         Height          =   192
         Index           =   1
         Left            =   120
      ...
      Begin SSOption optPoreDiffusivity 
         ...
         Width           =   1512
      End
      Begin Label lblPoreDiffusivityCorr 
         BorderStyle     =   1  'Fixed Single
         Height          =   252
         Left            =   1740
         TabIndex        =   101
      ...
      End
   End
   Begin SSFrame fraIonicTransport 
      ...
      Top             =   3540
      Width           =   4092
      Begin SSOption optIonicTransportCoeff 
         Caption         =   "Correlation"
         Height          =   192
         Index           =   0
         Left            =   120
      ...
      Begin SSOption optIonicTransportCoeff 
         ...
         Width           =   1512
      End
      Begin TextBox txtIonicTransCoeffUser 
         Enabled         =   0   'False
         Height          =   288
         Left            =   1740
         TabIndex        =   92
         ...
         Width           =   972
      End
      Begin ComboBox cboIonicTransportUnits 
         BackColor       =   &H00C0C0C0&
         Height          =   288
         Index           =   0
         Left            =   2820
      ...
      Begin ComboBox cboIonicTransportUnits 
         ...
         Width           =   1152
      End
      Begin Label lblIonicTransportCoeffCorr 
         BorderStyle     =   1  'Fixed Single
         Height          =   252
         Left            =   1740
         TabIndex        =   95
      ...
      End
   End
   Begin SSFrame fraLiquidDiffusivityInput 
      ...
      Top             =   4500
      Width           =   4092
      Begin ComboBox cboLiquidDiffusivityUnits 
         BackColor       =   &H00C0C0C0&
         Height          =   288
         Index           =   1
         Left            =   2820
      ...
      Begin ComboBox cboLiquidDiffusivityUnits 
         ...
         Width           =   1152
      End
      Begin TextBox txtLiquidDiffUserInput 
         Enabled         =   0   'False
         Height          =   288
         Left            =   1740
         TabIndex        =   86
         ...
         Width           =   972
      End
      Begin SSOption optLiquidDiffusivity 
         Caption         =   "User Input"
         Height          =   192
         Index           =   1
         Left            =   120
      ...
      Begin SSOption optLiquidDiffusivity 
         ...
         Width           =   1512
      End
      Begin Label lblLiquidDiffCorrelation 
         BorderStyle     =   1  'Fixed Single
         Height          =   252
         Left            =   1740
         TabIndex        =   85
      ...
      End
   End
   Begin SSFrame fraPoreDiffusivity 
      ...
      Top             =   4620
      Width           =   4092
      Begin Label lblPoreDiffusivityUnits 
         ...
         Width           =   972
      End
      Begin Label lblPoreDiffusivityValue 
         BorderStyle     =   1  'Fixed Single
         Height          =   192
         Index           =   1
         Left            =   1800
         ...
         Width           =   972
      End
      Begin Label lblPoreDiffusivity 
   ...
   Begin ComboBox cboIon 
      ...
      Width           =   2952
   End
   Begin SSFrame fraIonicTransportCoefficient 
      ...
      Top             =   120
      Width           =   4095
      Begin ComboBox cboIonicTransport 
         Height          =   300
         Left            =   1800
         Style           =   2  'Dropdown List
         TabIndex        =   109
         ...
         Width           =   2175
      End
      Begin Label lblIonicTransportCoeff 
         Alignment       =   1  'Right Justify
         BackStyle       =   0  'Transparent
      ...
      Begin Label lblIonicTransportCoeff 
         ...
         Width           =   1545
      End
      Begin Label lblIonicTranportCoeffValue 
         BorderStyle     =   1  'Fixed Single
         Height          =   195
         Index           =   13
         Left            =   1800
         ...
         Width           =   975
      End
      Begin Label lblIonicTransportCoeffUnits 
         BackStyle       =   0  'Transparent
         Caption         =   "cm/s"
         Height          =   195
         Index           =   13
      ...
      End
   End
   Begin SSFrame fraLiquidDiffusivity 
      Caption         =   "Liquid Diffusivity, Dl (Nernst-Haskell)"
      ForeColor       =   &H00000000&
      Height          =   3312
      Left            =   120
      TabIndex        =   2
      ...
      Begin Shape Shape4 
         ...
         Width           =   3852
      End
      Begin Label lblLiquidDiffusivityUnits 
         BackStyle       =   0  'Transparent
         Caption         =   "cm2/s"
         Height          =   192
         Index           =   3
         ...
         Width           =   972
      End
      Begin Label lblLiquidDiffusivityValue 
         BorderStyle     =   1  'Fixed Single
         Height          =   192
         Index           =   7
         Left            =   1800
         ...
         Width           =   972
      End
      Begin Label lblLiquidDiffusivity 
         Alignment       =   1  'Right Justify
         BackStyle       =   0  'Transparent
         Caption         =   "Liquid Diffusivity"
         Height          =   192
...
Sub cboIonicTransportUnits_Click (Index As Integer)
...
Sub cboLiquidDiffusivityUnits_Click (Index As Integer)
    Dim ValueToConvert As Double
    Dim ValueToDisplay As Double
    Dim ListIndex As Integer
...
Sub cboPoreDiffusivityUnits_Click (Index As Integer)
    Dim ValueToConvert As Double
    Dim ValueToDisplay As Double
    Dim ListIndex As Integer
...
Sub cmdKinetic_Click (Index As Integer)
...
Sub LoadLiquidDiffusivityParameters ()
...
Sub optIonicTransportCoeff_Click (Index As Integer, Value As Integer)
    Dim ValueToDisplay As Double
    Dim ListIndex As Integer
...
Sub optLiquidDiffusivity_Click (Index As Integer, Value As Integer)
    Dim ValueToDisplay As Double
    Dim ListIndex As Integer
...
Sub optPoreDiffusivity_Click (Index As Integer, Value As Integer)
    Dim ValueToDisplay As Double
    Dim ListIndex As Integer
...
Sub txtIonicTransCoeffUser_GotFocus ()
    Call TextGetFocus(txtIonicTransCoeffUser, Temp_Text)
End Sub

Sub txtIonicTransCoeffUser_KeyPress (KeyAscii As Integer)
...
Sub txtIonicTransCoeffUser_LostFocus ()
...
Sub txtLiquidDiffUserInput_GotFocus ()
    Call TextGetFocus(txtLiquidDiffUserInput, Temp_Text)
End Sub

Sub txtLiquidDiffUserInput_KeyPress (KeyAscii As Integer)
...
Sub txtLiquidDiffUserInput_LostFocus ()
    Dim ValueChanged As Integer, NewValue As Double
    Dim msg As String, CurrentUnits As Integer
    Dim OldValue As Double, ValueToDisplay As Double
    Dim i As Integer
...
Sub txtPoreDiffusivityUser_GotFocus ()
    Call TextGetFocus(txtPoreDiffusivityUser, Temp_Text)
End Sub

Sub txtPoreDiffusivityUser_KeyPress (KeyAscii As Integer)
...
Sub txtPoreDiffusivityUser_LostFocus ()
    Dim ValueChanged As Integer, NewValue As Double
    Dim msg As String, CurrentUnits As Integer
    Dim OldValue As Double, ValueToDisplay As Double
    Dim i As Integer
