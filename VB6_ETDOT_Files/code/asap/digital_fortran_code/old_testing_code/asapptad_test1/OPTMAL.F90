...
!C  ATTRIBUTES DLLEXPORT, STDCALL::OPTMAL
!C  ATTRIBUTES ALIAS:'_OPTMAL':: OPTMAL
!C  ATTRIBUTES REFERENCE::DL,VL,ST,DG,VG,QW,DP,CF,STC,AT,CINFL,CTOBJ,HENRYC,NUMCOM,PRESD,DIFL,DIFG,SAFFAC,TAG,MULTVQ,CEFFL,ERRORF
