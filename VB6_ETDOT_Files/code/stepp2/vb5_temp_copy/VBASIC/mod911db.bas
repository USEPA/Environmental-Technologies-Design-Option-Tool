...
Sub LoadFRM911DBFromInfo(FRM As Form, PROPERTY_CODE As Integer, dbtype As Integer, CurrentUnits)
  ...
  '  Dim Qd As QueryDef, Rs As Recordset
    ...
    Else
'
' START OF DIPPR801 CODE IN THIS IF STATEMENT.
'
        Call get801temps( _
            DBTbl, mintemp, maxtemp, TempDepend, rating, _
            pvalue, ref, reliable, _
            GetPropName(PROPERTY_CODE))
...
'
' END OF DIPPR801 CODE IN THIS IF STATEMENT.
'
    End If
