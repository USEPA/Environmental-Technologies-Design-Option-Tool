...
!CC      OPEN (UNIT = 9, FILE = 'C:\STEPP\RANDQ.DAT')
  ...
  10  CONTINUE
      ...
      IF (MDL-2) 20,30,65 !Changed by CB for StEPP 2 Original value was 20,30,70
...
!-- Following 1 lines commented by CB for Stepp 2
!  70  OPEN (UNIT = 10, FILE = 'AENV.DAT')

!  
!---------------END OF COMMENTS

!-- Following 5 lines added by CB on recc of Dr. Rogers to load AGLB data for Stepp 2
 ...
 75 OPEN(UNIT=10,FILE= 'AGLB.DAT')

 !--------- END OF NEW ADDITIONS BY CB
