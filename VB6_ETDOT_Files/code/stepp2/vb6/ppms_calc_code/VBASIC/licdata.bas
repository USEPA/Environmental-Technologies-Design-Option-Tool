...
'Global Const AppProgramKey = "PPMS_CALC"
Global Const AppProgramKey = "STEPP2"
...
Global Const AppCopyrightYears = "1999"
Global Const Application_Name = "Physical Property Management System - Calculator"
Global Const Name_App_Short = "PPMS-Calc"
Global Const Name_App_Long = "Physical Property Management System - Calculator"
Global Const FileExt_App = "prl"
Global Const fn_INI_name = "PPMS_CALC.INI"     'non-full name NOT including Windows path
'
...
Function LicFileData_Read( _
    return_fpath_dir_CPAS As String) _
    As Boolean
...
Dim fpath_dir_CPAS As String
  ...
  fn_CPASDIR_INI = MAIN_APP_PATH & "\CPASDIR.INI"
