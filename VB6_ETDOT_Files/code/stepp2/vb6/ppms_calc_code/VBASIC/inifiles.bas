...
Sub ini_putsetting0( _
    fn_ini As String, _
    ini_header As String, _
    INI_VarName As String, _
    ini_newsetting As String)
...
Dim temp As String
  ...
  BytesCopied = GetPrivateProfileString( _
