...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "pec - Win32 Debug"
F90=fl32.exe
RSC=rc.exe
...
ALL : "$(OUTDIR)\pec.exe" "$(OUTDIR)\pec.bsc"

CLEAN : 
	-@erase ".\Debug\pec.exe"
	-@erase ".\Debug\tisnt.obj"
	-@erase ".\Debug\pec.ilk"
	-@erase ".\Debug\pec.pdb"
	-@erase ".\Debug\pec.bsc"
	-@erase ".\Debug\tisnt.sbr"
...
F90_PROJ=/FR"Debug/" /Zi /I "Debug/" /c /nologo /Fo"Debug/" /Fd"Debug/pec.pdb" 
F90_OBJS=.\Debug/
...
"$(OUTDIR)\pec.bsc" : "$(OUTDIR)" $(BSC32_SBRS)
    $(BSC32) @<<
