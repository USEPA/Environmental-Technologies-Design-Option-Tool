	...
	REAL,PARAMETER :: PI=3.14159265359,TOL=1E-8
      ...
      REAL::CO,TBAR,CT,VAR,CNOT,PEC,PEO,
	+    X1,X2
	INTEGER ::NTANK
...
2010  FORMAT(1X,'Mean Residence Time (Tbar) (user-defined units) :',
     &  T50,E12.6)
2020  FORMAT(1X,'Number of tanks (dimensionless) :',T50,I6)
2030  FORMAT(1X,'Peclet Number for close system(dimensionless)   :',
     & T50,E12.6)
2040  FORMAT(1X,'Peclet Number for open system(dimensionless)   :',
     & T50,E12.6)
...
cccc	pause 'root must be bracketed in rtsafe'
