...
Global Const BETA_VOLUME = 70  ''nowproj.volume
Global Const BETA_RETENTION = 7.76    ''nowproj.tau
Global Const BETA_DBCP_CONCINI = 0.00000183 ''nowproj.targetcompounds(2).concini
