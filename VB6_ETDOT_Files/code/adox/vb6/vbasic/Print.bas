...
Dim FoundLowPoints As Boolean

  FoundLowPoints = False
  ...
  Next i
    ...
    If (FoundLowPoints) Then
       MsgBox "Warning:  Final Time Divided By Time Step must exceed 8 or the results may not plot properly.  The low level output file will be correct regardless."
    End If
