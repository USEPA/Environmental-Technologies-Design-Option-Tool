...
Sub Project_SetDefaults(ByRef p As Project_Type)
  ...
  p.TargetCompounds(1).cas = 0
  p.TargetCompounds(1).concini = 0#   'mg/L   changed from 1.8#
  p.TargetCompounds(1).mw = 200#
  p.TargetCompounds(1).xk = 2000#    'changed from 3000000000#
  '...... SET DEFAULTS FOR R1.
  Call TargetCompound_SetDefaults(p.TargetCompounds(2))
  p.TargetCompounds(2).comname = "R1"
  p.TargetCompounds(2).cas = 0
