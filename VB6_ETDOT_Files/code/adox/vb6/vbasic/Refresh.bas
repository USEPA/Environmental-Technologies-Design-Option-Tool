...
Type frmChemDB_Record_Type
  DB_Mode As Integer
  strSearchType As String
  strSearchString As String
  strChemicalName As String
  lngCASNumber As Long
  strMW As String
  strXK As String
End Type
Global frmChemDB_Record As frmChemDB_Record_Type
Global Const DB_Mode_VIEW = 1


Const Refresh_decl_end = True
...
'      frmMain.lbldesc2(3).Enabled = True
  ...
  Call AssignTextAndTag_WithRange(frmMain.txtData(0), NowProj.volume, -1#, 1E+20)
  If (NowProj.idreact = IDREACT_CMFR) Then
    Call AssignTextAndTag_WithRange(frmMain.txtData(1), NowProj.tau, -1#, 1E+20)
  End If
  Call AssignTextAndTag_WithRange(frmMain.txtData(5), NowProj.inf_h2o2, -1#, 1E+20)

  'NUMERICAL SIMULATION PARAMETERS.
  Call AssignTextAndTag_WithRange(frmMain.txtData(2), NowProj.ssize / 60#, -1#, 1E+20)
  Call AssignTextAndTag_WithRange(frmMain.txtData(3), NowProj.ttotal, -1#, 1E+20)
  If (NowProj.idreact = IDREACT_CMFR) Then
  ...
  Call AssignTextAndTag_WithRange(frmMain.txtData(6), NowProj.ph0, -1#, 1E+20)
  Call AssignTextAndTag_WithRange(frmMain.txtData(7), NowProj.phosph, -1#, 1E+20)
  Call AssignTextAndTag_WithRange(frmMain.txtData(8), NowProj.ticarbn, -1#, 1E+20)
  Call AssignTextAndTag_WithRange(frmMain.txtData(9), NowProj.alk, -1#, 1E+20)
...
Dim j As Integer
  ...
  'NAME AND CAS
  frmTarget.txtDataStr(0).Text = tc.comname
  frmTarget.txtDataStr(0).Tag = tc.comname
  frmTarget.txtData(15).Text = tc.cas
  frmTarget.txtData(15).Tag = tc.cas

  'PROPERTIES OF PROTONATED FORM.
  Call AssignTextAndTag_WithRange(frmTarget.txtData(0), tc.concini, -1#, 1E+20)
  Call AssignTextAndTag_WithRange(frmTarget.txtData(1), tc.val, -1#, 1E+20)
  Call AssignTextAndTag_WithRange(frmTarget.txtData(2), tc.mw, -1#, 1E+20)
  Call AssignTextAndTag_WithRange(frmTarget.txtData(3), tc.ncarbn, -1#, 1E+20)
  Call AssignTextAndTag_WithRange(frmTarget.txtData(4), tc.nsubstt, -1#, 1E+20)
  Call AssignTextAndTag_WithRange(frmTarget.txtData(5), tc.xk, -1#, 1E+20)
  ...
  'EQUILBRIUM REACTION.
  Call AssignTextAndTag_WithRange(frmTarget.txtData(6), tc.dep_xke, -1#, 1E+20)
  
  'PROPERTIES OF DEPROTONATED FORM.
  Call AssignTextAndTag_WithRange(frmTarget.txtData(7), tc.dep_val, -100000, 1E+20)
  Call AssignTextAndTag_WithRange(frmTarget.txtData(8), tc.dep_mw, -1#, 1E+20)
  Call AssignTextAndTag_WithRange(frmTarget.txtData(9), tc.dep_xk, -1#, 1E+20)

  'OTHER RATE CONSTANTS.
  Call AssignTextAndTag_WithRange(frmTarget.txtData(10), tc.xk_co3XM, -1#, 1E+20)
  Call AssignTextAndTag_WithRange(frmTarget.txtData(11), tc.xk_hpo4XM, -1#, 1E+20)
  Call AssignTextAndTag_WithRange(frmTarget.txtData(12), tc.xk_o2XM, -1#, 1E+20)
  Call AssignTextAndTag_WithRange(frmTarget.txtData(13), tc.xk_ho2X, -1#, 1E+20)
...
Sub refresh_frmChemDB(tc As TargetCompound_Type)

  'NAME AND CAS
  
  frmChemDB.txtDataStr(1).Text = tc.comname
  frmChemDB.txtDataStr(1).Tag = tc.comname
  frmChemDB.txtData(1) = tc.cas
  Call AssignTextAndTag_WithRange(frmChemDB.txtData(2), tc.mw, 0#, 1E+20)
  Call AssignTextAndTag_WithRange(frmChemDB.txtData(3), tc.xk, 0#, 1E+20)
