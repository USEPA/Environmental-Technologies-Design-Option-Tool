...
Global Const AppProgramKey = "ADOX"
...
Global Const AppCopyrightYears = "1998-2005"
Global Const Application_Name = "Advanced Oxidation Process Software"
Global Const Name_App_Short = "AdOx"
Global Const Name_App_Long = "Advanced Oxidation Process Software"
Global Const FileExt_App = "adx"
'Global Const BetaFileExt_app = "bdx"
Global Const fn_INI_name = "ADOX.INI"     'non-full name NOT including Windows path
'
...
Global Const Encrypted_User_Password = "adox"
...
'*'*'*
''''lfd.Z_RELEASETYPE = "BETA"    '' used for testing
'*'*'*
  Select Case Trim$(UCase$(lfd.Z_VERSIONTYPE))
    Case Trim$(UCase$("VER_INTERNAL_STUDENT")):
      AppWillExpire = False
