...
Dim i As Integer
  ...
  Filename = ""
  frmMain.Caption = AppName_For_Display_Short & "  -  (Untitled)"
  FileNote = ""
  ...
  With RoomParams
    '
    '/////////   TIME-VARIABLE Co   //////////////////////////////////
    ReDim .bool_ROOM_COINI_ISTIMEVAR(1 To Number_Compo_Max)
    For i = 1 To Number_Compo_Max
      .bool_ROOM_COINI_ISTIMEVAR(i) = False
    Next i
    ReDim .int_ROOM_NCOINI(1 To Number_Compo_Max)
    For i = 1 To Number_Compo_Max
      .int_ROOM_NCOINI(i) = 0
    Next i
    ReDim .dbl_ROOM_TCOINI(1 To Number_Compo_Max, 1 To Max_int_ROOM_NCOINI)
    ReDim .dbl_ROOM_COINI(1 To Number_Compo_Max, 1 To Max_int_ROOM_NCOINI)
    .u_ROOM_TCOINI = "min"
    .u_ROOM_COINI = "µg/L"
    '
    '/////////   TIME-VARIABLE w*A   /////////////////////////////////
    ReDim .bool_ROOM_EMITINI_ISTIMEVAR(1 To Number_Compo_Max)
    For i = 1 To Number_Compo_Max
      .bool_ROOM_EMITINI_ISTIMEVAR(i) = False
    Next i
    ReDim .int_ROOM_NEMITINI(1 To Number_Compo_Max)
    For i = 1 To Number_Compo_Max
      .int_ROOM_NEMITINI(i) = 0
    Next i
    ReDim .dbl_ROOM_TEMITINI(1 To Number_Compo_Max, 1 To Max_int_ROOM_NEMITINI)
    ReDim .dbl_ROOM_EMITINI(1 To Number_Compo_Max, 1 To Max_int_ROOM_NEMITINI)
    .u_ROOM_TEMITINI = "min"
  ...
  With RoomParams
    '
    '/////////   TIME-VARIABLE K   /////////////////////////////////
    ReDim .bool_ROOM_KINI_ISTIMEVAR(1 To Number_Compo_Max)
    For i = 1 To Number_Compo_Max
      .bool_ROOM_KINI_ISTIMEVAR(i) = False
    Next i
    ReDim .int_ROOM_NKINI(1 To Number_Compo_Max)
    For i = 1 To Number_Compo_Max
      .int_ROOM_NKINI(i) = 0
    Next i
    ReDim .dbl_ROOM_TKINI(1 To Number_Compo_Max, 1 To Max_int_ROOM_NKINI)
    ReDim .dbl_ROOM_KINI(1 To Number_Compo_Max, 1 To Max_int_ROOM_NKINI)
    .u_ROOM_TKINI = "min"
