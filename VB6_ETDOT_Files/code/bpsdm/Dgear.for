      SUBROUTINE DGEAR (N,T0,H0,Y0,TOUT,EPS,MF,INDEX)
      ...
      DOUBLE PRECISION SAVE2,PW,EPSJ,HUSED 
      DOUBLE PRECISION Y,TOUTP,AYI,D
      COMMON /GEAR1/ T,H,HMIN,HMAX,EPSC,UROUND,NC,MFC,KFLAG,JSTART  
      COMMON /GEAR2/ YMAX(144)  
      COMMON /GEAR3/ ERROR(144) 
      COMMON /GEAR4/ SAVE1(144) 
      COMMON /GEAR5/ SAVE2(144) 
      COMMON /GEAR6/ PW(20736)  
      COMMON /GEAR7/ IPIV(144)  
...
C   
     ...
     1DER,LMAX,IREDO,J,NSTEPJ,J1,J2,M,IER,NEWQ  
      ...
      DOUBLE PRECISION SAVE2,PW,HUSED   
  ...
  250 CON=-H*EL(1)  
C                                 CALL PSET 
      CALL NGE004 (Y,N0,CON,MITER,IER)  
...
C   
  ...
  910   TQ(K)=PERTST(NQ,METH,K) 
      ...
      RETURN
      END   
      SUBROUTINE NGE004 (Y,N0,CON,MITER,IER)
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)   
      INTEGER N0,MITER,IER,N,IDUMMY,IPIV,NSQ,I,J1,J 
      DOUBLE PRECISION Y,CON,T,H,DUMMY,UROUND,YMAX,SAVE1,SAVE2,PW
