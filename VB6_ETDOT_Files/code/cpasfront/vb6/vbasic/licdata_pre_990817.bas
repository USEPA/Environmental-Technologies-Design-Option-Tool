Attribute VB_Name = "LicData_pre_990817"
'Option Explicit
'
'Global Const AppProgramKey = "CPASFRONT"
'Global Const AppCopyrightYears = "1995-1999"
'Global Const AppName = "CPAS Desktop"
...
'  End If
'  temp = Trim$(INI_GetSetting0(fn_CPASDIR_INI, "Directory", "CPASDIR"))
'  fpath_dir_CPAS = temp
